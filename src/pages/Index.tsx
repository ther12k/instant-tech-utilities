...
const toolCategories = [
  {
    ...
    tools: [
      ...
      },
      {
        ...
        description: "Encode and decode URLs and query parameters for web applications.",
  ...
  },
  {
    ...
    description: "Format, validate and beautify different data formats",
    tools: [
      {
        name: "JSON Formatter",
  ...
  {
    name: "Visualization & Conversion",
    description: "Visual tools and converters",
    tools: [
      {
  ...
  },
  {
    ...
    description: "Generate secure tokens and hashes",
    tools: [
      {
        name: "Hash Generator",
